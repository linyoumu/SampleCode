...
- (void)sd_setHighlightedImageWithURL:(NSURL *)url options:(SDWebImageOptions)options progress:(SDWebImageProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock {
